...
const Modal = ({ isOpen, closeFn, content }: ModalProps) => {
  return (
    <Dialog
      className="fixed inset-0 items-start justify-center items-top flex overflow-auto py-7"
      open={isOpen}
      onClose={() => {}}
    >
      <div
        ...
        aria-hidden="true"
      />
      <Dialog.Panel className="w-[95vw] sm:w-[85vw] max-w-[540px] bg-grey-bg-1 z-20 relative rounded-lg p-4 sm:p-6">
